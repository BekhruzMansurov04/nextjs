  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-xl rounded-xl border border-gray-100 mt-8">
      ...
      <div className="space-y-3">
        ...
        <p className="text-lg text-gray-600"><strong className="text-gray-900">Email:</strong> {data.email}</p>
        <p className="text-lg text-gray-600"><strong className="text-gray-900">Body:</strong> {data.body}</p>
      </div>
    </div>
  );
};
